...
def train_predict(train_file, test_file, feature_map_file, predict_valid_file, predict_test_file,
                  feature_imp_file, n_est=100, n_leaf=31, lrate=.1, n_min=20, subcol=1.0,
                  subrow=1.0, subrow_freq=0, n_stop=30):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--n-est', type=int, dest='n_est', default=100)
    parser.add_argument('--n-leaf', type=int, dest='n_leaf', default=31)
    parser.add_argument('--lrate', type=float, default=0.1)
    parser.add_argument('--subcol', type=float, default=1.0)
    parser.add_argument('--subrow', type=float, default=1.0)
    parser.add_argument('--subrow-freq', type=int, default=0, dest='subrow_freq')
    parser.add_argument('--n-min', type=int, default=20, dest='n_min')
    parser.add_argument('--early-stop', type=int, dest='n_stop', default=30)
